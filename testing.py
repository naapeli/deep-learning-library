...
errors = model.fit(x_train, y_train, val_data=(x_val, y_val), epochs=50, batch_size=4, learning_rate=0.1, metrics=["loss", "val_loss"], shuffle_data=True, new_shuffle_per_epoch=True)
