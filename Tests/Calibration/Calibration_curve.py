...
plt.plot(prob_pred, prob_true, marker="o", label="Calibration Curve Logistic Regression")
...
prob_true, prob_pred = calibration_curve(ytest, yprob, n_bins=10, strategy=strategy)
plt.plot(prob_pred, prob_true, marker="o", label="Calibration Curve Gaussian Naive Bayes")
...
prob_true, prob_pred = calibration_curve(ytest, yprob, n_bins=10, strategy=strategy)
plt.plot(prob_pred, prob_true, marker="o", label="Calibration Curve SVC")
...
prob_true, prob_pred = calibration_curve(ytest, yprob, n_bins=10, strategy=strategy)
plt.plot(prob_pred.squeeze(), prob_true.squeeze(), marker="o", label="Calibration Curve Calibrated Gaussian Naive Bayes")
