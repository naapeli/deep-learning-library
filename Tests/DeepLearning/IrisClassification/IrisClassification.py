"""
Classification, callbacks and model serialization
===================================================

This script implements a basic residual model to classify the iris dataset. It incorporates 
callbacks to monitor the progress and to reduce overfitting during the training. Lastly it 
showcases saving the trained model and predicting with the saved model.
"""
from DLL.DeepLearning.Model import Model, save_model, load_model
from DLL.DeepLearning.Layers import Dense, Identity, Add, LayerList
from DLL.DeepLearning.Layers.Regularisation import BatchNorm, GroupNorm, InstanceNorm, LayerNorm, Dropout
from DLL.DeepLearning.Layers.Activations import ReLU, SoftMax
from DLL.DeepLearning.Losses import CCE
from DLL.DeepLearning.Optimisers import SGD
from DLL.DeepLearning.Initialisers import Xavier_Normal, Xavier_Uniform, Kaiming_Normal, Kaiming_Uniform
from DLL.DeepLearning.Callbacks import EarlyStopping, BackUp, ReduceLROnPlateau
