...
model.train_kernel(epochs=200, optimiser=Adam(), verbose=True)  # try to comment out this line of code to see how the covariance kernel learns the correct parameters
