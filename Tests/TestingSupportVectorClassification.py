...
model1 = SVC(kernel=Kernels.SquaredExponentialCovariance(correlation_length=5), C=1)
start1 = perf_counter()
...
model2 = SVCSMO(kernel=Kernels.SquaredExponentialCovariance(correlation_length=5), C=1)
start2 = perf_counter()
...
model3 = svm.SVC(kernel="rbf", C=1, gamma=5, decision_function_shape='ovr')
start3 = perf_counter()
