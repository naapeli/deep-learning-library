...
n_classes = 2
X, y = datasets.make_blobs(n_samples=1000, n_features=2, cluster_std=2, centers=n_classes, random_state=3)
...
model = GradientBoostingClassifier(n_trees=20, max_depth=3, learning_rate=0.5, loss="log_loss")
