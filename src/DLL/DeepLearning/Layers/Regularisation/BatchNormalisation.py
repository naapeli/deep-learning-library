...
class BatchNorm(BaseRegularisation):
    ...
    def forward(self, input, training=False, **kwargs):
        ...
        where :math:`x` is the input, :math:`\\mathcal{E}[x]` is the expected value or the mean accross the batch dimension, :math:`\\text{var}(x)` is the variance accross the variance accross the batch dimension, :math:`\\epsilon` is a small constant and :math:`\\gamma` and :math:`\\beta` are trainable parameters.
