...
.. "auto_examples\UnsupervisedLearning\DiscriminantAnalysisClassification.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_UnsupervisedLearning_DiscriminantAnalysisClassification.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_UnsupervisedLearning_DiscriminantAnalysisClassification.py:
...
.. image-sg:: /auto_examples/UnsupervisedLearning/images/sphx_glr_DiscriminantAnalysisClassification_001.png
   :alt: LDA DLL, LDA sklearn, QDA DLL, QDA sklearn
   :srcset: /auto_examples/UnsupervisedLearning/images/sphx_glr_DiscriminantAnalysisClassification_001.png
...
.. _sphx_glr_download_auto_examples_UnsupervisedLearning_DiscriminantAnalysisClassification.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: DiscriminantAnalysisClassification.ipynb <DiscriminantAnalysisClassification.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: DiscriminantAnalysisClassification.py <DiscriminantAnalysisClassification.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: DiscriminantAnalysisClassification.zip <DiscriminantAnalysisClassification.zip>`
