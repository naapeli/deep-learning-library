...
.. "auto_examples\Trees\BoostingClassifiers.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_Trees_BoostingClassifiers.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_Trees_BoostingClassifiers.py:
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image-sg:: /auto_examples/Trees/images/sphx_glr_BoostingClassifiers_001.png
         :alt: Ada boost errors and alphas
         :srcset: /auto_examples/Trees/images/sphx_glr_BoostingClassifiers_001.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/Trees/images/sphx_glr_BoostingClassifiers_002.png
         :alt: Gradient boosting classifier loss as a function of fitted trees
         :srcset: /auto_examples/Trees/images/sphx_glr_BoostingClassifiers_002.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/Trees/images/sphx_glr_BoostingClassifiers_003.png
         :alt: XGBoost loss as a function of fitted trees
         :srcset: /auto_examples/Trees/images/sphx_glr_BoostingClassifiers_003.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/Trees/images/sphx_glr_BoostingClassifiers_004.png
         :alt: LGBM loss as a function of fitted trees
         :srcset: /auto_examples/Trees/images/sphx_glr_BoostingClassifiers_004.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/Trees/images/sphx_glr_BoostingClassifiers_005.png
         :alt: gradient boosting ROC | auc = 0.881, ada boost ROC | auc = 0.892, XG boost ROC | auc = 0.882, LGBM ROC | auc = 0.860
         :srcset: /auto_examples/Trees/images/sphx_glr_BoostingClassifiers_005.png
         :class: sphx-glr-multi-img

    *

      .. image-sg:: /auto_examples/Trees/images/sphx_glr_BoostingClassifiers_006.png
         :alt: Gradient boosting, Adaptive boosting, XG boosting, Light gradient boosting
         :srcset: /auto_examples/Trees/images/sphx_glr_BoostingClassifiers_006.png
         :class: sphx-glr-multi-img
...
.. _sphx_glr_download_auto_examples_Trees_BoostingClassifiers.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: BoostingClassifiers.ipynb <BoostingClassifiers.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: BoostingClassifiers.py <BoostingClassifiers.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: BoostingClassifiers.zip <BoostingClassifiers.zip>`
